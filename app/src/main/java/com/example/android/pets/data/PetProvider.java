...
public class PetProvider extends ContentProvider {
    ...
    private int updatePet(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        if (values.containsKey(InventoryContract.ProductEntry.COLUMN_SUPPLIER_NAME)) {
            String gender = values.getAsString(InventoryContract.ProductEntry.COLUMN_SUPPLIER_NAME);
            if (gender == null || !InventoryContract.ProductEntry.isValidGender(gender)) {
        ...
        if (values.containsKey(InventoryContract.ProductEntry.COLUMN_SUPPLIER_PHONENUMBER)) {
            // Check that the weight is greater than or equal to 0 kg
            Integer weight = values.getAsInteger(InventoryContract.ProductEntry.COLUMN_SUPPLIER_PHONENUMBER);
            if (weight != null && weight < 10) {
                throw new IllegalArgumentException("A valid pone number is required ");
            }
        }
...
//                return database.delete(InventoryContract.ProductEntry.TABLE_NAME, selection, selectionArgs);
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            case PETS:
                return InventoryContract.ProductEntry.COLUMN_PRODUCT_NAME;
            case PET_ID:
                return InventoryContract.ProductEntry._ID;
            default:
